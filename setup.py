...
setup(name="ep_report_generator",
      ...
      install_requires=[
          ...
          "PyQt5<=5.15.0",
          "PyQt5-stubs",
          "epcore @ hg+https://anonymous:anonymous@hg.ximc.ru/eyepoint/epcore@t-51956#egg=epcore",
          # "ivviewer @ hg+https://anonymous:anonymous@hg.ximc.ru/eyepoint/ivviewer@dev-0.1#egg=ivviewer",
      ],
      dependency_links=[
          "hg+https://anonymous:anonymous@hg.ximc.ru/eyepoint/epcore@t-51956#egg=epcore",
