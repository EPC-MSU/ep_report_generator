...
setup(name="ep_report_generator",
      ...
      dependency_links=[
          "hg+https://anonymous:anonymous@hg.ximc.ru/eyepoint/epcore@9a86b71afa17#egg=epcore",
          "hg+https://anonymous:anonymous@hg.ximc.ru/eyepoint/ivviewer@Version0.1.8#egg=ivviewer",
      ],
