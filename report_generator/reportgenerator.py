...
class ReportGenerator(QObject):
    ...
    def _read_config(self, config: Dict[ConfigAttributes, Any]) -> None:
        ...
        project_name = self._config.get(ConfigAttributes.PROJECT_NAME, None)
        dir_base_name = ut.create_report_directory_base_name(project_name)
        self._dir_name = ut.create_report_directory_path(parent_directory, dir_base_name)
